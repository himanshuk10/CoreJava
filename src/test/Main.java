...
//        System.out.println(sum);
    ...
    static void firstNonRepeatingNumberInList(){
        List<Integer> list = Arrays.asList(1,2,4,1,2,3);
        Optional<Integer> firstNonRepeatingInteger = list.stream()
                ...
                .findFirst();
//        firstNonRepeatingInteger.ifPresent(System.out::println);
    }
